...
public class HitService {
    ...
    public void calculateHit(LottoTicket lottoTicket, WinningLotto winningLotto) {
        ...
        this.winningStatistic = new WinningStatistic(enumMap);
    }

    public void calculateYield(WinningStatistic winningStatistic, PurchaseAmount purchaseAmount) {
        ...
        this.yield = new Yield(Math.round(sum * 1000 / purchaseAmount.getMoney()) / 10.0);
    }
